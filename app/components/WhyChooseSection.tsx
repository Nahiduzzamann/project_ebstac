...
export default function WhyChooseSection() {
  return (
    <div className=" py-16 px-6  container p-3 mx-auto">
      ...
      <div className="md:flex justify-between gap-6 items-center">
        ...
        <div className="max-w-md lg:max-w-lg">
          ...
          <p className="mt-3 text-gray-700 text-lg leading-relaxed">
            ...
            data-driven decision making and on-the-ground expertise, means we
            are uniquely positioned to help you navigate risk and shape a more
