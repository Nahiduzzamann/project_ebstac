...
const links = [
  ...
  { name: "ONLINE COURSES", href: "/pages/online-courses" },
  ...
  return (
    <div className="">
      ...
      <motion.div
        ...
        className={`bg-yellow  z-50 w-full ${pathname === "/pages/Login" || pathname === "/pages/SignUp" ? 'fixed top-0':'fixed top-0 '} `}
      >
      ...
      <motion.div
        ...
        className={` bg-lightWhite  z-50 w-full ${pathname === "/pages/Login" || pathname === "/pages/SignUp" ? 'fixed top-[60px] ':'fixed top-[60px] '}  ${
